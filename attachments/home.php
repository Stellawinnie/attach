        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <p>We know that getting an attachment is not easy at all.<br> As a company saps make your work easier<br>
                        <br>
                    <ul>
                        <li>What you get from saps
                        <li>Assistance to secure attachment position on desired company</li>
                          <li>Wide range of engagement terms: volunteers, project based</li> 
                          <LI>This is low cost access to quality</LI> 
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-6 services">
                    ...
                    <a href="apply.php" class="btn btn-success" role="button" align="centre">Apply here</a>
